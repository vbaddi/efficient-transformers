...
model = MistralForCausalLM.from_pretrained(
    model_id, torch_dtype=torch.float32, use_cache=True, attn_implementation="eager", sliding_window=32
)
...
exec_info = QEfficient.cloud_ai_100_exec_kv(
    tokenizer=tokenizer, qpc_path=qpc_path, prompt="Who are you?", generation_len=64, device_id=[0]
)
