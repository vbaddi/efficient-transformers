...
class QEffGemma3DecoderLayer(Gemma3DecoderLayer):
    def forward(
        ...
        **kwargs,
        ...
        # print(f'Post Attention Layer Residual Add is {torch.min(hidden_states)} and {torch.max(hidden_states)}')
        # hidden_states = (residual.float() + hidden_states.float()).clamp_(-65504, 65504)
