...
def attention_configurator(
    ...
    """
    mode = (blocking_mode or os.environ.get("ATTENTION_BLOCKING_MODE", "hqkv")).lower()
...
def build_transformer_blocking_config(
    ...
    seq_len = _require_value(_get_attr_or_key(specializations, ("seq_len", "sequence_length")), "sequence length")
    ...
    resolved_mode = _normalize_attention_mode(blocking_mode or os.environ.get("ATTENTION_BLOCKING_MODE", "hqkv"))
